...
import { Target, DollarSign, Truck, Ticket, CheckCircle, XCircle, Plus } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Card>
        <div className="flex justify-between items-center">
          ...
          <button className="bg-primary text-white px-6 py-2 rounded hover:bg-gray-800 transition-colors flex items-center">
